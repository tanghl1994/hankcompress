...
parser.add_argument('--acc-step', default=1, type=int,
                    metavar='N',
                    help='accumulation step for simulation multiple gpus')
parser.add_argument('--freeze-epoch', default=15000, type=int,
                    metavar='N',
                    help='accumulation step for simulation multiple gpus')
parser.add_argument('--rankk', default=10, type=int,
                    metavar='N',
                    help='accumulation step for simulation multiple gpus')
...
def main():
    ...
    # here args.rank is the machine ID, args.world_size is number of machines
...
def train(train_loader, model, criterion, optimizer, epoch, args, adam_freeze):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        acc_key = globalstep % args.acc_step
